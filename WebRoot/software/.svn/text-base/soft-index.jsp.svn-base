          ...
          <div class="borderc">
            ...
            <div class="borderf">
                <div class="activefrist">
                      <ul>
                         <li><a href="../huodong.html" target="_blank"><img src="../images/soft/songruanjian.jpg" alt="注册会员送软件" width="90" height="70"></a></li>
                         <li style="width:170px;">
                            <a href="../huodong.html" target="_blank"><h2>注册充值 软件免费送</h2></a>
                            充值满50元，即可获得软件注册！<a href="../huodong.html" target="_blank" style="color:#36648B;margin-left:10px;">[详细]</a>
                         </li>
                      </ul>
                </div>
                <div class="activefrist">
                      <ul>
                         <li><a href="../huodong.html" target="_blank"><img src="../images/soft/shouci.jpg" alt="注册会员送软件" width="90" height="70"></a></li>
                         <li style="width:170px;">
                            <a href="../huodong.html" target="_blank"><h2>首次购彩保你中</h2></a>
                            注册用户首次购彩，一彩票送您5元彩金，保您开门红！<a href="../huodong.html" target="_blank" style="color:#36648B;margin-left:10px;">[详细]</a>
                         </li>
                      </ul>
                </div>
                <div class="activefrist">
                      <ul>
                         <li><a href="../huodong.html" target="_blank"><img src="../images/soft/zhong100.jpg" alt="注册会员送软件" width="90" height="70"></a></li>
                         <li style="width:170px;">
                            <a href="../huodong.html" target="_blank"><h2>369竞彩 中1000送100</h2></a>
                            活动期间凡单一方案中奖满1000元,即加奖100元...<a href="../huodong.html" target="_blank" style="color:#36648B;margin-left:10px;">[详细]</a>
                         </li>
                      </ul>
                </div>
          ...
          <div class="borderc">
            ...
            <div class="borderRR">
               ...
               <div class="professorSSQ">
                   <ul>
                      <li onMouseOver="this.style.backgroundColor='#cc0000'" onMouseOut="this.style.backgroundColor='#eeeeee'"><img src="../images/img/right_26.jpg" width="59" height="61" alt="双色球专家"><br />王小兵</li>
                      <li onMouseOver="this.style.backgroundColor='#cc0000'" onMouseOut="this.style.backgroundColor='#eeeeee'"><img src="../images/img/zucaiduizhen02.jpg" width="59" height="61" alt="双色球专家"><br />张璐</li>
                      <li onMouseOver="this.style.backgroundColor='#cc0000'" onMouseOut="this.style.backgroundColor='#eeeeee'"><img src="../images/img/shuangseqiu01.jpg" width="59" height="61" alt="双色球专家"><br />小豆丁</li>
                      <li onMouseOver="this.style.backgroundColor='#cc0000'" onMouseOut="this.style.backgroundColor='#eeeeee'"><img src="../images/img/right_26.jpg" width="59" height="61" alt="双色球专家"><br />369cai</li>
                   </ul>
               </div>
