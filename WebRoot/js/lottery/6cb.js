...
function validateNum()
{
	...
	for(var i = 1; i <= 6; i++) {
			...
			if(g_cur_matchList1[i][0]==1 && g_cur_matchList1[i][1]==1 && g_cur_matchList1[i][3]==1)
			{
	...
	for(var i = 1; i <= 6; i++) {
			...
			if(g_cur_matchList2[i][0]==1 && g_cur_matchList2[i][1]==1 && g_cur_matchList2[i][3]==1)
			{
...
function displayHistory(last, pre_list)
{
	...
	history_last += "<ul><li>"+redballs[0]+"</li><li>"+redballs[1]+
					"</li><li>"+redballs[2]+"</li><li>"+redballs[3]+"</li><li>"+redballs[4]+"</li><li>"+redballs[5]+"</li><li>"+redballs[6]+"</li><li>"+redballs[7]+"</li><li>"+redballs[8]+"</li><li>"+redballs[9]+"</li><li>"+redballs[10]+"</li><li>"+redballs[11]+"</li>";
