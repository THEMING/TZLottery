...
<div class="outer">
	<div class="Trend">
    	<div class="Trend_title_left">
        	<div class="Trend_online">
            	<div class="Titile">七星彩在线分析统计</div>
            </div>
    		<div class="Trend_title_bg">
        		<div class="GGTitile">
					<ul id="Active">
                		<li class="GGTitile1 GGTCurrent_bg"><a href="/direction/fbt.htm?type=qxc&tt=js">七星彩分布图</a></li>
                    	<li class="GGTitile2"><a href="/direction/plt.htm?tt=js&type=qxc">七星彩频率图</a></li>
                    	<li class="GGTitile2"><a href="/direction/zst.htm?tt=js&type=qxc&chartType=zst">七星彩走势图</a></li>
               		</ul>
            	</div>
        	</div>
            <div class="Trend_Con">
        		<ul>
            		<li class="TC_li_Current">七星彩分布图</li>
        ...
        <div class="Trend_title_right" >
        	<div class="Trend_soft">
            	<div class="Titile">七星彩软件统计分析</div> 
            </div>
            <div class="softCon">
        ...
        <div class="Trend_table">
        	<div class="Trend_Session">
        		<ul>
        		    <li class="TC_li_Current"><a href="/direction/fbt.htm?type=qxc&num=10&tt=js"">最近10期</a></li>
            		<li ><a href="/direction/fbt.htm?type=qxc&num=30&tt=js"">最近30期</a></li>
                	<li><a href="/direction/fbt.htm?type=qxc&num=50&tt=js"">最近50期</a></li>
            	</ul>
        	</div>
            <div class="Trend_table_con">
       	  		<table width="1400" cellpadding="0" cellspacing="0" bordercolor="#000" border="1" style="border:1px #fbcca5 solid;">
  <tr class="Trend_tr" >
  ...
  <tr>
    ...
    <td class="${fn:contains(fn:substring(result,8,9),0)?'Trend_td_red Trend_ball_orange':'Trend_td_red' }">0</td>
    <td class="${fn:contains(fn:substring(result,8,9),1)?'Trend_td_red Trend_ball_orange':'Trend_td_red' }">01</td>
    <td class="${fn:contains(fn:substring(result,8,9),2)?'Trend_td_red Trend_ball_orange':'Trend_td_red' }">02</td>
    <td class="${fn:contains(fn:substring(result,8,9),3)?'Trend_td_red Trend_ball_orange':'Trend_td_red' }">03</td>
    <td class="${fn:contains(fn:substring(result,8,9),4)?'Trend_td_red Trend_ball_orange':'Trend_td_red' }">04</td>
    <td class="${fn:contains(fn:substring(result,8,9),5)?'Trend_td_red Trend_ball_orange':'Trend_td_red' }">05</td>
    <td class="${fn:contains(fn:substring(result,8,9),6)?'Trend_td_red Trend_ball_orange':'Trend_td_red' }">06</td>
    <td class="${fn:contains(fn:substring(result,8,9),7)?'Trend_td_red Trend_ball_orange':'Trend_td_red' }">07</td>
    <td class="${fn:contains(fn:substring(result,8,9),8)?'Trend_td_red Trend_ball_orange':'Trend_td_red' }">08</td>
    <td class="${fn:contains(fn:substring(result,8,9),9)?'Trend_td_red Trend_ball_orange Trend_border_z':'Trend_td_red Trend_border_z'}">09</td>
    <td class="${fn:contains(fn:substring(result,10,11),0)?'Trend_td_red Trend_ball_violet':'Trend_td_red' }">0</td>
    <td class="${fn:contains(fn:substring(result,10,11),1)?'Trend_td_red Trend_ball_violet':'Trend_td_red' }">01</td>
    <td class="${fn:contains(fn:substring(result,10,11),2)?'Trend_td_red Trend_ball_violet':'Trend_td_red' }">02</td>
    <td class="${fn:contains(fn:substring(result,10,11),3)?'Trend_td_red Trend_ball_violet':'Trend_td_red' }">03</td>
    <td class="${fn:contains(fn:substring(result,10,11),4)?'Trend_td_red Trend_ball_violet':'Trend_td_red' }">04</td>
    <td class="${fn:contains(fn:substring(result,10,11),5)?'Trend_td_red Trend_ball_violet':'Trend_td_red' }">05</td>
    <td class="${fn:contains(fn:substring(result,10,11),6)?'Trend_td_red Trend_ball_violet':'Trend_td_red' }">06</td>
    <td class="${fn:contains(fn:substring(result,10,11),7)?'Trend_td_red Trend_ball_violet':'Trend_td_red' }">07</td>
    <td class="${fn:contains(fn:substring(result,10,11),8)?'Trend_td_red Trend_ball_violet':'Trend_td_red' }">08</td>
    <td class="${fn:contains(fn:substring(result,10,11),9)?'Trend_td_red Trend_ball_violet Trend_border_z':'Trend_td_red Trend_border_z'}">09</td>
     <td class="${fn:contains(fn:substring(result,10,11),0)?'Trend_td_red Trend_ball_red':'Trend_td_red' }">0</td>
    <td class="${fn:contains(fn:substring(result,10,11),1)?'Trend_td_red Trend_ball_red':'Trend_td_red' }">01</td>
    <td class="${fn:contains(fn:substring(result,10,11),2)?'Trend_td_red Trend_ball_red':'Trend_td_red' }">02</td>
    <td class="${fn:contains(fn:substring(result,10,11),3)?'Trend_td_red Trend_ball_red':'Trend_td_red' }">03</td>
    <td class="${fn:contains(fn:substring(result,10,11),4)?'Trend_td_red Trend_ball_red':'Trend_td_red' }">04</td>
    <td class="${fn:contains(fn:substring(result,10,11),5)?'Trend_td_red Trend_ball_red':'Trend_td_red' }">05</td>
    <td class="${fn:contains(fn:substring(result,10,11),6)?'Trend_td_red Trend_ball_red':'Trend_td_red' }">06</td>
    <td class="${fn:contains(fn:substring(result,10,11),7)?'Trend_td_red Trend_ball_red':'Trend_td_red' }">07</td>
    <td class="${fn:contains(fn:substring(result,10,11),8)?'Trend_td_red Trend_ball_red':'Trend_td_red' }">08</td>
    <td class="${fn:contains(fn:substring(result,10,11),9)?'Trend_td_red Trend_ball_red':'Trend_td_red'}">09</td>
  </tr>
   </s:iterator>   
</table>
			</div>
