	...
	<div class="Trend">
        ...
        <div class="Trend_table">
        	<div class="Trend_Session">
        		<ul>
        		    <li ><a href="/direction/plt.htm?type=${type }&num=10&tt=${tt}&football=football">最近10期</a></li>
            		<li ><a href="/direction/plt.htm?type=${type }&num=30&tt=${tt}&football=football">最近30期</a></li>
                	<li><a href="/direction/plt.htm?type=${type }&num=50&tt=${tt}&football=football">最近50期</a></li>
            	</ul>
        	</div>
...
<img src="/images/lottery/red.JPG"  width="20" height="10"/>胜
<img src="/images/lottery/yellow.JPG" width="20" height="10"/>平
<img src="/images/lottery/green.JPG" width="20" height="10"/>负
			</div>
