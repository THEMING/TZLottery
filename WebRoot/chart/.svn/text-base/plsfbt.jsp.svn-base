	...
	<div class="Trend">
    	<div class="Trend_title_left">
        	<div class="Trend_online">
            	<div class="Titile">排列三在线分析统计</div>
            </div>
    		<div class="Trend_title_bg">
        		<div class="GGTitile">
					<ul id="Active">
                		<li class="GGTitile1 GGTCurrent_bg"><a href="/direction/fbt.htm?type=pls&tt=js">排列三分布图</a></li>
                    	<li class="GGTitile2"><a href="/direction/plt.htm?tt=${tt }&type=pls">排列三频率图</a></li>
                    	<li class="GGTitile2"><a href="/direction/zst.htm?tt=${tt }&type=pls&chartType=zst">排列三走势图</a></li>
               		</ul>
            	</div>
        	</div>
            <div class="Trend_Con">
        		<ul>
            		<li class="TC_li_Current">排列三分布图</li>
        ...
        <div class="Trend_title_right">
        	<div class="Trend_soft">
            	<div class="Titile">排列三统计分析软件</div> 
            </div>
            <div class="softCon">
				<div class="T_softPic"><img src="../images/img/369software01.jpg" width="61" height="61" /></div>
              <div class="T_softText">免费下载使用3D数据统计分析软件，数据每日更新，几十种数据图标灵活查看</div>
          <div class="T_softBtn">
        ...
        <div class="Trend_table">
        	<div class="Trend_Session">
        		<ul>
        		    <li class="TC_li_Current"><a href="/direction/pls.htm?type=ssq&num=10&tt=js"">最近10期</a></li>
            		<li ><a href="/direction/fbt.htm?type=pls&num=30&tt=js"">最近30期</a></li>
                	<li><a href="/direction/fbt.htm?type=pls&num=50&tt=js"">最近50期</a></li>
            	</ul>
        	</div>
