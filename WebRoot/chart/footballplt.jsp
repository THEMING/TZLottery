    	...
    	<div class="Trend_title_left">
    		...
    		<div class="Trend_title_bg">
        		<div class="GGTitile">
                    ...
                    <li class="GGTitile2"><a href="/direction/plt.htm?tt=cc&type=${type }&chartType=zst&football=football">${ball }走势图</a></li>
               		</ul>
            	</div>
        	</div>
            <div class="Trend_Con">
        		<ul>
            		<li ><a href="/direction/plt.htm?tt=cc&type=${type }&football=football">场次</a></li>
                	<li ><a href="/direction/plt.htm?tt=lianxue&type=${type }&football=football">连续</a></li>
                	<li ><a href="/direction/plt.htm?tt=duandian&type=${type }&football=football">断点</a></li>
            	</ul>
        	</div>
