...
<form id="form1" action="/oss/basketball/jclqManager.aspx" method="post">
	...
	<table>
		...
		<tr id="query">
			<td >销售日期:<input type="text" name="saleDate" value="${saleDate}" style="width:90" onClick="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true});"/></td>
...
<form id="form2" action="/oss/basketball/jclqManager.aspx" method="post">
...
<div id="openPrize_box" style="display:none">
	<iframe id="fun_iframe" src="/oss/Basketball/manageJCLQOpenPrize.aspx" scrolling="no" frameborder="0" style="width:1200px; height:800px"></iframe>
</div>
