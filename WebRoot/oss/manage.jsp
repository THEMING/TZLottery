...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td height="104" colspan="2" valign="top"><iframe border="0" width="100%" name="topFrame" id="topFrame" height="100%" frameborder="0" src="adminTunnel.aspx?action=head"></iframe></td>
  </tr>
  <tr>
    <td width="215" valign="top" style="border-right: 1px solid #cfcfcf;" id="leftFrameId"><iframe  width="100%" name="leftFrame" id="leftFrame" SCROLLING="yes" frameborder="0" src="adminTunnel.aspx?action=left"></iframe></td>
