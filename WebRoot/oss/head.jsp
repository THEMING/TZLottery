...
<div id="header">
   <div id="logo"><img src="skin/01/images/logo.gif"/></div>
   
      <div id="quickBt">当前用户：<strong>${adminUser.adminName}</strong>　　[<a href="adminLogin.aspx?action=exit"  target="_top">退出登录</a> | <a href="adminLogin.aspx?action=revise" target="mainframe">修改密码</a>] </div>
      <div id="topmenu">
  	  <ul>
