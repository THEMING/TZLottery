...
var termNo;
	...
	function zq()
	{
		...
		alert(termNo);
		$("#action_id").val("fetch6cbMatchList");
		$("#form_id").submit();
	}
</script>
</head>
...
<form id="form_id" action="/oss/football/6cbManager.htm" method="post">
	<s:hidden name="action" id="action_id" value="saveMathces"/>
    <table border="0" cellspacing="0" cellpadding="2" width="100%">
		<tr>
			<td align="center" colspan="2" >6场半全场编辑</td>
		</tr>
		<tr bgcolor="#FFFFFF">
