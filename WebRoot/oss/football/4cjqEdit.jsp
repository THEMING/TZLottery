	...
	function doSubmit()
   	{
		...
		for(var m = 1; m < 5; m++){
			...
			dv.push(m+"|"+$("#lsname"+m).val()+"|"+$("#gametime"+m).val()+"|"+$("#hname"+m).val()+"|"+$("#vname"+m).val());
		}
...
<form id="form_id" action="/oss/football/4cjqManager.htm" method="post">
		           		...
		           		<td>
		    	       		<table>
		    	          		<tr>
		    	               		...
		    	               		<td>比赛时间：<input type="text" id="gametime<s:property value="boutIndex"/>"  name="gametime<s:property value="boutIndex"/>" style='width:200' value="<s:date name="matchTime" format="yyyy-MM-dd HH:mm"/>" />
		    	               		</td>
