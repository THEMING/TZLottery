...
<body>
	 <s:form action="manageTerm" method="post" namespace="/oss/term">
			...
			<div style="height:20px;padding:10px 0 10px 260px;"><label>**********<s:property value="type"/>-七星彩——彩期编辑**********</label><input type="submit" name="submit" value="抓取"></div>
     </s:form>
