	...
	<body>
	 <s:form action="manageTerm" method="post" namespace="/oss/term">
		...
		<s:form action="manageTerm" method="post" namespace="/oss/term">
			...
			<%--
			<s:hidden name="lotteryTerm.prizeLevels[6].id" />
			<s:hidden name="lotteryTerm.prizeLevels[7].id" />
			<s:hidden name="lotteryTerm.prizeLevels[8].id" />
			 --%>
			...
			<!-- 
			<tr>
			<td width="20%">大乐透的12选2:</td>
			<td><input type="text" name="lotteryTerm.otherTotalSale" value="${lotteryTerm.otherTotalSale }"/></td>
			</tr>
			 -->
			<tr>
			<td width="20%">彩期状态:</td>
			...
			<tr>
			<td width="20%"> 一等奖追加:</td>
			<td><input type="text" name="lotteryTerm.prizeLevels[0].addBetNum" value="${lotteryTerm.prizeLevels[0].addBetNum }"/>注</td>
			<td><input type="text" name="lotteryTerm.prizeLevels[0].addPrize" value="${lotteryTerm.prizeLevels[0].addPrize }"/>元</td>
			</tr>
			<tr>
			...
			<tr>
			<td width="20%">二等奖追加:</td>
			<td><input type="text" name="lotteryTerm.prizeLevels[1].addBetNum" value="${lotteryTerm.prizeLevels[1].addBetNum }"/>注</td>
			<td><input type="text" name="lotteryTerm.prizeLevels[1].addPrize" value="${lotteryTerm.prizeLevels[1].addPrize }"/>元</td>
			</tr>
			<tr>
			...
			<tr>
			<td width="20%"> 三等奖追加:</td>
			<td><input type="text" name="lotteryTerm.prizeLevels[2].addBetNum" value="${lotteryTerm.prizeLevels[2].addBetNum}"/>注</td>
			<td><input type="text" name="lotteryTerm.prizeLevels[2].addPrize" value="${lotteryTerm.prizeLevels[2].addPrize }"/>元</td>
			</tr>
			<tr>
			...
			<td><input type="text" name="lotteryTerm.prizeLevels[3].betNum" value="${lotteryTerm.prizeLevels[3].betNum }"/>注 </td>
 			...
 			<tr>
 			<td width="20%"> 四等奖追加:</td>
 			<td><input type="text" name="lotteryTerm.prizeLevels[3].addBetNum" value="${lotteryTerm.prizeLevels[3].addBetNum }"/>注</td>
 			<td><input type="text" name="lotteryTerm.prizeLevels[3].addPrize" value="${lotteryTerm.prizeLevels[3].addPrize }"/>元</td>
 			</tr>
            <tr>
            ...
            <tr>
            <td width="20%">五等奖追加:</td>
            <td><input type="text" name="lotteryTerm.prizeLevels[4].addBetNum" value="${lotteryTerm.prizeLevels[4].addBetNum }"/>注</td>
            <td><input type="text" name="lotteryTerm.prizeLevels[4].addPrize" value="${lotteryTerm.prizeLevels[4].addPrize }"/>元</td>
            </tr>
            <tr>
            ...
            <!-- 
            <tr>
            <td width="20%">六等奖追加:</td>
            <td><input type="text" name="lotteryTerm.prizeLevels[5].addBetNum" value="${lotteryTerm.prizeLevels[5].addBetNum }"/>注</td>
            <td><input type="text" name="lotteryTerm.prizeLevels[5].addPrize" value="${lotteryTerm.prizeLevels[5].addPrize }"/>元</td>
            </tr>
            <tr>
            <td width="20%">七等奖:<input type="hidden" name="lotteryTerm.prizeLevels[6].name" value="七等奖"></td>
            <td><input type="text" name="lotteryTerm.prizeLevels[6].betNum" value="${lotteryTerm.prizeLevels[6].betNum }"/>注</td>
            <td><input type="text" name="lotteryTerm.prizeLevels[6].prize" value="${lotteryTerm.prizeLevels[6].prize }"/>元</td>
            </tr>
             <tr>
            <td width="20%">七等奖追加:</td>
            <td><input type="text" name="lotteryTerm.prizeLevels[6].addBetNum " value="${lotteryTerm.prizeLevels[6].addBetNum }"/>注</td>
            <td><input type="text" name="lotteryTerm.prizeLevels[6].addPrize" value="${lotteryTerm.prizeLevels[6].addPrize}"/>元</td>
            </tr>
            <tr>
            <td width="20%">八等奖:<input type="hidden" name="lotteryTerm.prizeLevels[7].name" value="八等奖"></td>
            <td><input type="text" name="lotteryTerm.prizeLevels[7].betNum" value="${lotteryTerm.prizeLevels[7].betNum }"/>注</td>
            <td><input type="text" name="lotteryTerm.prizeLevels[7].prize" value="${lotteryTerm.prizeLevels[7].prize }"/>元</td>
            </tr>
            <tr>
            <td width="20%">12选2:<input type="hidden" name="lotteryTerm.prizeLevels[8].name" value="12选2"></td>
            <td><input type="text" name="lotteryTerm.prizeLevels[8].betNum" value="${lotteryTerm.prizeLevels[8].betNum }"/>注</td>
            <td><input type="text" name="lotteryTerm.prizeLevels[8].prize" value="${lotteryTerm.prizeLevels[8].prize}"/>元</td>
            </tr>
             -->
            </table>
