   ...
   <script type="text/javascript">
	...
	<body>
	 <s:form action="manageTerm" method="post" namespace="/oss/term">
			...
			<input type="submit" name="submit" value="抓取" >
		...
		<s:form action="manageTerm" method="post" namespace="/oss/term">
			...
			<td width="20%" rowspan="1">开奖结果:</td>
				<td ><input type="text" width=140 name="lotteryTerm.result" id="lotteryTerm.result" value="${lotteryTerm.result }"/></td>
			</tr>
			...
			<div style="clear:both"></div>
 			...
 			<table width="60%" border="1" align="left" cellspacing="0" bordercolorlight="#003399" bordercolordark="#FFFFFF">
 			<tr>
			<td width="20%">任九:<input type="hidden" name="lotteryTerm.prizeLevels[0].name" value="任九"></td>
