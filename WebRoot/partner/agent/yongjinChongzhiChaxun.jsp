...
<h3><strong>佣金转账查询</strong></h3>
	<form action="yongjinChongzhiChaxun.htm" method="post" >
	<input type="hidden" id="action" name="action" value="yongjinChongzhiChaxun">
	<br/>
	
	转账时间:<input type="text" name="f_starTime" id="f_starTime" value="<s:date name="f_starTime" format="yyyy-MM-dd HH:mm:ss"/>"  onClick="WdatePicker({dateFmt:'yyyy-MM-dd 00:00:00',readOnly:true});"/>-
	...
	<input type="submit" value="查询" />
		<br/>
		<br/>
		总佣金：<font color="red">${sumComm}</font>(元) 总转账佣金：<font color="red">${sumYongjinNum}</font>(元) 剩余佣金：<font color="red">${surplusComm}</font>(元)
		<br/>
		<br/>
