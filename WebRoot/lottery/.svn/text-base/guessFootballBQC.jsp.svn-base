...
<head>
	...
	<title>一彩票_购彩大厅_竞彩足球_半全场</title>
	<meta name="description" content="一彩票购彩大厅竞彩足球半全场购买频道为您提供代购投注，缩水过滤软件投注，统计分析软件，机选投注，单式上传，合买投注，追号投注，手机投注。彩票改变生活，我们改变彩票。" />
	<meta name="keywords" content="半全场,竞彩足球半全场,竞彩足球缩水过滤软件,竞彩合买" />
...
<script type="text/javascript" src="../js/util/validate.js"></script>
	...
	<script type="text/javascript">
               ...
               function clickdan()
		{
			...
			window.location.href="/lottery/BQCIndex.htm?danduo=1";
		}
		
		function clickduo()
		{

			window.location.href="/lottery/BQCIndex.htm";
		}
	...
	<div class="lottery_main">
        ...
        <div class="jczuqiuzhongleitab">
           <ul>
              ...
              <li class="sshover"><a href="/lottery/BQCIndex.htm" style="color:#fff;font-weight:bold;font-size:15px;">半全场</a></li>
				...
				<table class="tournament_table">
					...
					<tbody>
						<tr>
							...
							<th>客队</th>
						    <th>数据</th>
							<th class="th_table_right_bet_title">胜-胜</th>
							<th class="th_table_right_bet_title">胜-平</th>
							<th class="th_table_right_bet_title">胜-负</th>
							<th class="th_table_right_bet_title">平-胜</th>
							<th class="th_table_right_bet_title">平-平</th>
							<th class="th_table_right_bet_title">平-负</th>
							<th class="th_table_right_bet_title">负-胜</th>
							<th class="th_table_right_bet_title">负-平</th>
							<th class="th_table_right_bet_title">负-负</th>
						</tr>
					</tbody>
				</table>
...
<div class="clear"> </div>
<strong class="red" id="bqc0_<s:property value='boutIndex'/>">0</strong></label>
								</td>
...
<div class="clear"> </div>
<strong class="red" id="bqc1_<s:property value='boutIndex'/>">0</strong></label>
								</td>
...
<div class="clear"> </div>
<strong class="red" id="bqc2_<s:property value='boutIndex'/>">0</strong></label>
								</td>
								<td class="table_right_bet"> <!-- 3 -->
									<label><input matchNo = "<s:property value="boutIndex"/>" index = 4 type="checkbox" class="chbox" onclick="clickChkBet(this,<s:property value="boutIndex"/>,4)"/> 
<div class="clear"> </div>
<strong class="red" id="bqc3_<s:property value='boutIndex'/>">0</strong></label>
								</td>
								<td class="table_right_bet"> <!-- 4 -->
									<label><input matchNo = "<s:property value="boutIndex"/>" index = 5 type="checkbox" class="chbox" onclick="clickChkBet(this,<s:property value="boutIndex"/>,5)"/> 
<div class="clear"> </div>
<strong class="red" id="bqc4_<s:property value='boutIndex'/>">0</strong></label>
								</td>
								<td class="table_right_bet"> <!-- 5 -->
									<label><input matchNo = "<s:property value="boutIndex"/>" index = 6 type="checkbox" class="chbox" onclick="clickChkBet(this,<s:property value="boutIndex"/>,6)"/> 
<div class="clear"> </div>
<strong class="red" id="bqc5_<s:property value='boutIndex'/>">0</strong></label>
								</td>
								<td class="table_right_bet"> <!-- 6 -->
									<label><input matchNo = "<s:property value="boutIndex"/>" index = 7 type="checkbox" class="chbox" onclick="clickChkBet(this,<s:property value="boutIndex"/>,7)"/> 
<div class="clear"> </div>
<strong class="red" id="bqc6_<s:property value='boutIndex'/>">0</strong></label>
								</td>
								<td class="table_right_bet"> <!-- 7 -->
									<label><input matchNo = "<s:property value="boutIndex"/>" index = 8 type="checkbox" class="chbox" onclick="clickChkBet(this,<s:property value="boutIndex"/>,8)"/> 
<div class="clear"> </div>
<strong class="red" id="bqc7_<s:property value='boutIndex'/>">0</strong></label>
								</td>
								<td class="table_right_bet"> <!-- 8 -->
									<label><input matchNo = "<s:property value="boutIndex"/>" index = 8 type="checkbox" class="chbox" onclick="clickChkBet(this,<s:property value="boutIndex"/>,9)"/> 
<div class="clear"> </div>
<strong class="red" id="bqc8_<s:property value='boutIndex'/>">0</strong></label>
								</td>
							</tr>
						</s:iterator>
					</tbody>
