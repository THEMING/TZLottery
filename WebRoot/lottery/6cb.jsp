...
<meta name="description" content="一彩票购彩大厅竞彩半全场购买频道为您提供代购投注，缩水过滤软件投注，统计分析软件，机选投注，单式上传，合买投注，追号投注，手机投注。彩票改变生活，我们改变彩票。">
<meta name="keywords" content="6场半全场,足彩半全场, 足彩缩水过滤软件,足彩合买，半全场合买">
<title>一彩票_购彩大厅_6场半全场</title>
...
<script type="text/javascript" src="../js/lottery/6cb.js"></script>
...
<script language="javascript">
	...
	function changeTerm()
	{
		...
		this.location.href="/lottery/index.htm?lotteryType=6cb&termNo="+termNo;
	}
...
<div class="outer">
  	...
  	<div class="lotter_left" style="margin-top:0px;">
    	...
    	<div class="ball">
            ...
            <div class="ball_Remind" style="display:block">
				<ul>
					...
					<li>&nbsp;&nbsp;6场半全胜负游戏由购买者对6场比赛中每场比赛上半场45分钟(含伤情补时)和全场90分钟(含伤情补时)的胜平负结果(3、1、0)进行投注，可单式、复式、倍投。每注2元人民币，单注彩票中奖奖金最高限额500万元。<a target="_blank" href="/help/help-4-11.htm">[详细规则]</a></li>
        ...
        <div class="Ball_Method" style="display:block;">       	
            ...
            <div id="playType_standard" class="BM_body">
            	<div class="ZC6_select" style="height:450px">选择投注:</div>                
                <div class="ZC6_title" style="margin-bottom:7px">
                	<ul>
                	...
                	<ul>
                        ...
                        <li class="ZC6_bifen">
                        	<div class="ZC6_bf">
                        		<div class="ZC6_bf1">
                            		<ul>
                                    	<li id="match_<s:property value="boutIndex"/>_31" class="off31" onclick="onClickNumber1(this, <s:property value="boutIndex"/>, 3)" />
										<li id="match_<s:property value="boutIndex"/>_11" class="off11" onclick="onClickNumber1(this, <s:property value="boutIndex"/>, 1)" />
										<li id="match_<s:property value="boutIndex"/>_01" class="off01" onclick="onClickNumber1(this, <s:property value="boutIndex"/>, 0)" />
                            		</ul>
                                </div>
                                <div class="ZC6_bf2">
                                	<ul>
                            			<li id="match_<s:property value="boutIndex"/>_32" class="off32" onclick="onClickNumber2(this, <s:property value="boutIndex"/>, 3)" />
										<li id="match_<s:property value="boutIndex"/>_12" class="off12" onclick="onClickNumber2(this, <s:property value="boutIndex"/>, 1)" />
										<li id="match_<s:property value="boutIndex"/>_02" class="off02" onclick="onClickNumber2(this, <s:property value="boutIndex"/>, 0)" />
                                    </ul>
                            	</div>
                            </div>
                        </li>
                        <li class="ZC6_quanbao">
                        	<div class="ZC6_qb">
                        		<div class="ZC6_qb1">
                        		    <input id="match_checkbox_<s:property value="boutIndex"/>1" type="checkbox" onclick="onSelectAll1(this, <s:property value="boutIndex"/>)"/>
                        		</div>
								<div class="ZC6_qb2">
                                	<input id="match_checkbox_<s:property value="boutIndex"/>2" type="checkbox" onclick="onSelectAll2(this, <s:property value="boutIndex"/>)"/>
                                </div>
                            </div>
                       </li>
                    </ul>
    ...
    <!--right start-->
  	<div class="lotter_right" style="margin-top:0px">
        ...
        <!--开奖历史　end-->
    	<!--统计分析 start-->
		<div class="Stat" style="dislay:none">
        	<div class="STitleBg">
