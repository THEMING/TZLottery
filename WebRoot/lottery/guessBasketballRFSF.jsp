...
<title>369竟彩网_购彩大厅_竞彩篮球_让分胜负</title>
...
<script type="text/javascript">
	...
	function clickdan()
	{
		...
		window.location.href="/lottery/JCLQRFSFIndex.htm?danduo=1";
	}
	
	function clickduo()
	{

		window.location.href="/lottery/JCLQRFSFIndex.htm";
	}
	...
	<div class="lottery_main">
        ...
        <div class="lanqiutabed">
            <ul>
              ...
              <li class="tabed"><a href="/lottery/JCLQRFSFIndex.htm" style="color:#fff;font-size:14px;font-weight:bold;">让分胜负</a></li>
                    ...
                    <tbody>
                     <s:iterator value="matchArrangelist">
		                	<tr   id="line_<s:property value='boutIndex'/>">
								...
								<td> <!-- 客队 VS 客队 -->
									<span>
										<s:property value="awaryTeam"/> VS <s:property value="homeTeam"/>
										<s:if test="danduo == 1">
											<!-- 让球 -->
												<span style="color:#690;">(<s:property value="danguanRangFen"/>)</span>
										</s:if>
										<s:else>
												<span style="color:#690;">(<s:property value="duoguanRangFen"/>)</span>
										</s:else>
									</span>
								</td>
