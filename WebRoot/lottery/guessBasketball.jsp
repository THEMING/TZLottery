...
<title>369竟彩网_购彩大厅_竞彩篮球_胜平负</title>
<meta name="description" content="一彩票购彩大厅竞彩篮球胜平负购买频道为您提供代购投注，缩水过滤软件投注，统计分析软件，机选投注，单式上传，合买投注，追号投注，手机投注。彩票改变生活，我们改变彩票。" />
<meta name="keywords" content="让球胜平负,竞彩篮球胜平负, 竞彩篮球缩水过滤软件,竞彩篮球合买，让球胜平负, 竞彩胜平负合买" />
...
<script type="text/javascript">
	...
	function clickdan()
	{
		...
		window.location.href="/lottery/JCLQSFIndex.htm?danduo=1";
	}
	
	function clickduo()
	{

		window.location.href="/lottery/JCLQSFIndex.htm";
	}
...
<%@include  file="../head.jsp"%>
	<div class="lottery_main">
        ...
        <div class="lanqiutabed">
            <ul>
             <li class="tabed"><a href="lottery/JCLQSFIndex.htm" style="color:#fff;font-size:14px;font-weight:bold;">胜负</a></li>
              <li><a href="/lottery/JCLQRFSFIndex.htm">让分胜负</a></li>
              <li><a href="/lottery/JCLQSFCIndex.htm">胜分差</a></li>
                ...
                <table width="100%" class="oddscontent-table" cellspacing="0" cellpadding="0">
                    ...
                    <s:iterator value="matchArrangelist">
		                	<tr id="line_<s:property value='boutIndex'/>">
								...
								<td> <!-- 客队 VS 主队 -->
									<span><s:property value="awaryTeam"/> VS <s:property value="homeTeam"/></span>
								</td>
							<!-- 	<td><a href="/detail/datadetail.htm?type=jczq&no=<s:property value='boutIndex'/>&leagueName=<s:property value='matchName'/>">析</a></td>
								-->
								<!--<td>--><!-- 平均赔率/投注比例 -->
								...
								<!--</td>-->
								<td class="oupeibgco"> <!-- 负 -->
									<label><input matchNo = "<s:property value="boutIndex"/>" index = 1 type="checkbox" class="chenck" onclick="clickChkBet(this,<s:property value="boutIndex"/>,1)"/> 
<strong class="red" id="fpeilv_<s:property value='boutIndex'/>">0</strong></label>
								</td>
								<td class="oupeibgco"> <!-- 胜 -->
									<label><input matchNo = "<s:property value="boutIndex"/>" index = 2 type="checkbox" class="chenck" onclick="clickChkBet(this,<s:property value="boutIndex"/>,2)"/> 
<strong class="red" id="speilv_<s:property value='boutIndex'/>">0</strong></label>
								</td>
							</tr>
						</s:iterator>
					</tbody>
