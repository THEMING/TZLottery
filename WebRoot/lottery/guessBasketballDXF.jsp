...
<script type="text/javascript">
	...
	function clickdan()
	{
		...
		window.location.href="/lottery/JCLQDXFIndex.htm?danduo=1";
	}
	
	function clickduo()
	{

		window.location.href="/lottery/JCLQDXFIndex.htm";
	}
	...
	<div class="lottery_main">
        ...
        <div class="lanqiutabed">
            <ul>
              ...
              <li class="tabed"><a href="/lottery/JCLQDXFIndex.htm" style="color:#fff;font-size:14px;font-weight:bold;">大小分</a></li>
                  ...
                  <tbody>
						<s:iterator value="matchArrangelist">
		                	<tr   id="line_<s:property value='boutIndex'/>">
								...
								<s:if test="danduo == 1">
									<td> <!-- 预设总分 -->
										<span style="color:#690;"><s:property value="danguanDaXiaoQiu"/></span>
									</td>
								</s:if>
								<s:else>
									<td> <!-- 预设总分 -->
										<span style="color:#690;"><s:property value="duoguanDaXiaoQiu"/></span>
									</td>
								</s:else>
								<td> <!-- 客队 -->
...
<strong class="red" id="dfpeilv_<s:property value='boutIndex'/>">0</strong></label>
								</td>
								<td class="table_right_bet"> <!-- 小分 -->
...
<strong class="red" id="xfpeilv_<s:property value='boutIndex'/>">0</strong></label>
								</td>
							</tr>
						</s:iterator>
					</tbody>
