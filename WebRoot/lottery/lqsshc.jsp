...
<body>
	...
	<div class="lottery_main">
		您现在的位置：<a href="/"  target="_blank" style="color:#FF0000">一彩票首页</a> &gt; <a href="/lotteryHall/">购彩大厅</a> &gt; 竞彩篮球
				...
				<table class="tournament_table">
					...
					<tbody>
						<tr>
							...
							<th>客队</th>							
							<th>全场比分</th>
							<th class="th_table_right_bet_title">胜负</th>
							<th class="th_table_right_bet_title">让分胜负</th>
							<th class="th_table_right_bet_title">胜分差</th>
							<th class="th_table_right_bet_title">大小分</th>							
						</tr>
					</tbody>
				</table>
					...
					<tbody>
						<s:iterator value="matchArrangelist">
		                	<tr id="line_<s:property value='boutIndex'/>">
								...
								<td> <!-- 让球 -->
									<span><s:property value="danguanRangFen"/></span>
								</td>
								<td> <!-- 大小球 -->
									<span><s:property value="danguanDaXiaoQiu"/></span>
								</td>
								<td> <!-- 客队 -->
								...
								<td class="table_right_bet"> 
									${spRangfenSf}|${rfsfResultOther }
								</td>
								<td class="table_right_bet"> <!-- 胜 -->
									<label> ${spSfc}|${sfcResultOther }</label>
								</td>
							
								<td class="table_right_bet"> <!-- 负 -->
									<label>${spDxf}|${dxfResultOther }</label>
								</td>
