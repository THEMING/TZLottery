...
<head>
	...
	<title>一彩票_购彩大厅_竞彩足球_总进球</title>
	<meta name="description" content="一彩票购彩大厅竞彩足球总进球购买频道为您提供代购投注，缩水过滤软件投注，统计分析软件，机选投注，单式上传，合买投注，追号投注，手机投注。彩票改变生活，我们改变彩票。" />
	<meta name="keywords" content="总进球,竞彩足球总进球,竞彩足球缩水过滤软件,竞彩合买" />
...
<script type="text/javascript" src="../js/util/validate.js"></script>
	...
	var ishide = 0;
              ...
              function clickdan()
		{
			...
			window.location.href="/lottery/ZJQSIndex.htm?danduo=1";
		}
		
		function clickduo()
		{

			window.location.href="/lottery/ZJQSIndex.htm";
		}		
	function shouqi()
		{
        ...
        <div class="ql_weizhi">
            ...
            <div class="jczuqiuzhongleitab">
               <ul>
                  ...
                  <li class="sshover"><a href="/lottery/ZJQSIndex.htm" style="color:#fff;font-weight:bold;font-size:15px;">总进球</a></li>
		...
		<div class="BGTOP-LEFT">
           ...
           <div class="clear"></div>
			<div class="football_table">
				<table class="tournament_table" cellpadding="0" cellspacing="0">
					<colgroup>
						<col width="7%"/>
						<col width="6%"/>
						<col width="7%"/>
					...
					<tbody>
						<tr>
							...
							<th>客队</th>
							<th>数据</th>
							<th class="th_table_right_bet_title">0</th>
							<th class="th_table_right_bet_title">1</th>
							<th class="th_table_right_bet_title">2</th>
							<th class="th_table_right_bet_title">3</th>
							<th class="th_table_right_bet_title">4</th>
							<th class="th_table_right_bet_title">5</th>
							<th class="th_table_right_bet_title">6</th>
							<th class="th_table_right_bet_title">7+</th>
						</tr>
					</tbody>
				</table>
				
				
				<table class="tournament_table" id="d_2011-08-09" cellpadding="0" cellspacing="0">
					<colgroup>
						<col width="7%"/>
						<col width="6%"/>
						<col width="7%"/>
					...
					<tbody>
						<s:iterator value="matchArrangelist">
		                	<tr id="line_<s:property value='boutIndex'/>">
								...
								<td class="table_right_bet"> <!-- 0 -->
									<label><input matchNo = "<s:property value="boutIndex"/>" index = 1 type="checkbox" class="ql_chbox" onclick="clickChkBet(this,<s:property value="boutIndex"/>,1)"/>
<div class="clear"> </div>									 
<strong class="red" id="jqs0_<s:property value='boutIndex'/>">0</strong></label>
								</td>
								<td class="table_right_bet"> <!-- 1 -->
									<label><input matchNo = "<s:property value="boutIndex"/>" index = 2 type="checkbox" class="ql_chbox" onclick="clickChkBet(this,<s:property value="boutIndex"/>,2)"/> 
<div class="clear"> </div>
<strong class="red" id="jqs1_<s:property value='boutIndex'/>">0</strong></label>
								</td>
								<td class="table_right_bet"> <!-- 2 -->
									<label><input matchNo = "<s:property value="boutIndex"/>" index = 3 type="checkbox" class="ql_chbox" onclick="clickChkBet(this,<s:property value="boutIndex"/>,3)"/> 
<div class="clear"> </div>
<strong class="red" id="jqs2_<s:property value='boutIndex'/>">0</strong></label>
								</td>
								<td class="table_right_bet"> <!-- 3 -->
									<label><input matchNo = "<s:property value="boutIndex"/>" index = 4 type="checkbox" class="ql_chbox" onclick="clickChkBet(this,<s:property value="boutIndex"/>,4)"/> 
<div class="clear"> </div>
<strong class="red" id="jqs3_<s:property value='boutIndex'/>">0</strong></label>
								</td>
								<td class="table_right_bet"> <!-- 4 -->
									<label><input matchNo = "<s:property value="boutIndex"/>" index = 5 type="checkbox" class="ql_chbox" onclick="clickChkBet(this,<s:property value="boutIndex"/>,5)"/> 
<div class="clear"> </div>
<strong class="red" id="jqs4_<s:property value='boutIndex'/>">0</strong></label>
								</td>
								<td class="table_right_bet"> <!-- 5 -->
									<label><input matchNo = "<s:property value="boutIndex"/>" index = 6 type="checkbox" class="ql_chbox" onclick="clickChkBet(this,<s:property value="boutIndex"/>,6)"/> 
<div class="clear"> </div>
<strong class="red" id="jqs5_<s:property value='boutIndex'/>">0</strong></label>
								</td>
								<td class="table_right_bet"> <!-- 6 -->
									<label><input matchNo = "<s:property value="boutIndex"/>" index = 7 type="checkbox" class="ql_chbox" onclick="clickChkBet(this,<s:property value="boutIndex"/>,7)"/> 
<div class="clear"> </div>
<strong class="red" id="jqs6_<s:property value='boutIndex'/>">0</strong></label>
								</td>
								<td class="table_right_bet"> <!-- 7 -->
									<label><input matchNo = "<s:property value="boutIndex"/>" index = 8 type="checkbox" class="ql_chbox" onclick="clickChkBet(this,<s:property value="boutIndex"/>,8)"/> 
<div class="clear"> </div>
<strong class="red" id="jqs7_<s:property value='boutIndex'/>">0</strong></label>
								</td>
							</tr>
						</s:iterator>
					</tbody>
		...
		<!--right-->
         <div class="BGTOP-RIGHT">
			...
			<div class="step_2" style="padding-bottom:17px;">
				...
				<div class="clear"></div>
				<td><label id="lab_1c1" class="chuan_chuan" disabled="disabled" for="1c1" style="display:none;">单关</label>
