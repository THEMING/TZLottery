...
<meta name="description" content="一彩票购彩大厅福彩3D购买频道为您提供代购投注，缩水过滤软件投注，统计分析软件，机选投注，单式上传，合买投注，追号投注，手机投注。彩票改变生活，我们改变彩票。">
<meta name="keywords" content="福彩3D,奖金奖池,组三,组六,单式上传,福彩3D合买">
<title>一彩票_购彩大厅_福彩3D</title>
...
<script type="text/javascript" src="../js/lottery/fc3d.js"></script>
...
<div class="outer">
  	...
  	<div class="lotter_left" style="margin-top:0px; ">
    	<!--期次信息 start-->
    	<div class="ball">
        	<div class="ball_img"><img src="../images/lottery/fc3d_logo.jpg" width="101" height="86" /></div>
            ...
            <div class="ball_Remind" style="display:block">
				<ul>
					...
					<li>1、直选选择3位数命中即可得1000元。</li>
					<li>2、组选3选择2位不同数字，组选6选择三位不同数字。<a target="_blank" href="/help/help-4-3.htm">[详细规则]</a></li>
					<li>3、使用3D快选优化专家，多种快选模式及过滤模式，帮您节省资金，获取大奖，<a href="/download.htm?fileName=3dsetup.zip">[免费下载]</a></li> 
				</ul>
			</div>
        </div>
        <!--期次信息 end-->
        ...
        <div class="history_body">
			...
			<div id="history_last" class="history_LastNum"></div>
          	<div id="history_pre_list" class="history_preNum"></div>
           	<div class="history_more"><a href="/direction/fbt.htm?type=3d&tt=js&num=30">更多在线图表</a></div>
        </div>
