...
<title>福彩3D${result.termNo}期开奖详情_中奖号码-一彩票</title>
<meta name="Keywords" content="福彩3D${result.termNo}开奖,福彩3D${result.termNo}开奖号码,福彩3D${result.termNo}开奖详情" />
<meta name="Description" content="一彩票第一时间为您提供准确的福彩3D${result.termNo}期开奖详情,全面的福彩3D${result.termNo}期开奖信息，方便您查阅兑奖，祝您中大奖！" />
...
var term=$("#term_no option:selected").val();
  ...
  $.LotteryTerm.callback = function(json){
	...
	$.LotteryTerm._request({action:'ajaxTermInfo',term: term,type:'3d'});
}
</script>
...
<div class = "container">
	<div class="prize_main">
		...
		<div class="right_box_info">
			<h3>一彩票首页 &gt; 开奖公告 &gt; 福利彩票 &gt; 福彩3D开奖详情</h3>
           	<div class="right_box_title">
                <h4 class="pic_fc3d"></h4>
                <h4 style="padding-left:15px">福彩3D开奖信息</h4><h2>&nbsp[每日开奖]</h2>               
			</div>
			...
			<div class="right_box_cont">
				<div class="right_box_cont_top">
			  		<p class="blue_bor_b">
						...
						福彩3D 第 <strong class="red f_14" id="termNO">${result.termNo}</strong> 期
                    ...
                    <div class="prize_result">
						...
						<div style="float: right;"><a href="/prizedetail/3dindex.htm" target="_blank">开奖历史</a> | <a href="/direction/fbt.htm?type=3d" target="_blank">走势图</a></div> 
			  		</div>
					
					<div class="clear"></div>
                    <div class="operation">
                    	<input type="image" src="../images/369caibg/369cai_40.gif" class="btn_dg" value="立即投注" onclick="parent.location.href='/lottery/index.htm?lotteryType=3d'"/>                   	
                    </div>
