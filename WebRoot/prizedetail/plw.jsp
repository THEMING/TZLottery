...
<title>排列五开奖历史_开奖公告-一彩票</title>
<meta name="keywords" content="排列五开奖,排列五开奖结果,排列五开奖号码,排列五开奖公告"/>
<meta name="description" content="排列五历史开奖公告频道为广大彩民朋友提供一个查阅近期排列五开奖结果,排列五开奖号码,排列五开奖公告的便捷直观的查询平台,方便用户兑阅排列五彩票中奖情况,以及其他更多排列五开奖相关信息。"/>
...
<div class = "container">
	<div class="prize_main">
		...
		<div class="right_box_history">
			<h3>一彩票首页 &gt; 开奖公告 &gt; 体育彩票 &gt; 排列5开奖历史</h3>
			<div class="right_box_tab">
				<div class="right_box_cont">
					<form action="plwindex.htm">
						<table class= "prize_detail_tab" cellSpacing=0 cellPadding=0>
	                    	...
	                    	<s:iterator value="page.result" id="term">
			                    	...
			                    	<td><a href="/prizedetail/plw_${termNo}.htm" target="_blank"><img style="border:0px" src="../images/prizedetail/magnifier.png"/></a></td>
									<td><a href="/direction/fbt.htm?tt=js&type=plw" target="_blank"><img style="border:0px" src="../images/prizedetail/trend.png" /></a></td>
			                  	</tr>
	                   	  	</s:iterator>
						</table>
						<div class="turn_page">
