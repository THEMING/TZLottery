...
<title>排列三开奖历史_开奖公告-一彩票</title>
<meta name="keywords" content="排列三开奖,排列三开奖结果,排列三开奖号码,排列三开奖公告"/>
<meta name="description" content="排列三历史开奖公告频道为广大彩民朋友提供一个查阅近期排列三开奖结果,排列三开奖号码,排列三开奖公告的便捷直观的查询平台,方便用户兑阅排列三彩票中奖情况,以及其他更多排列三开奖相关信息。"/>
						...
						<table class= "prize_detail_tab" cellSpacing=0 cellPadding=0>
							...
							<s:iterator value="page.result" id="term">
									...
									<td>${prizeLevels[0].betNum}</td>
		                    	 	...
		                    	 	<td><a href="/prizedetail/pls_${termNo}.htm" target="_blank"><img style="border:0px" src="../images/prizedetail/magnifier.png"/></a></td>
									<td><a href="/direction/fbt.htm?tt=js&type=pls" target="_blank"><img style="border:0px" src="../images/prizedetail/trend.png" /></a></td>
		                  	  	</tr>
                   	  		</s:iterator>						
						</table>
						<div class="turn_page">
