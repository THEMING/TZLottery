...
<title>七乐彩${result.termNo}期开奖详情_中奖号码-一彩票</title>
<meta name="Keywords" content="七乐彩${result.termNo}开奖,七乐彩${result.termNo}中奖号码,七乐彩${result.termNo}开奖详情" />
<meta name="Description" content="一彩票第一时间为您提供准确的七乐彩${result.termNo}开奖,全面的七乐彩${result.termNo}中奖号码信息，以及权威的七乐彩${result.termNo}开奖详情,中奖分布等方便您查阅兑奖，祝您中大奖！" />
...
<div class = "container">
	<div class="prize_main">
		...
		<div class="right_box_info">
			<h3>一彩票首页 &gt; 开奖公告 &gt; 福利彩票 &gt; 七乐彩开奖详情</h3>
           	<div class="right_box_title">
                <h4 class="pic_qlc"></h4>
                <h4 style="padding-left:15px">七乐彩开奖信息</h4><h2>&nbsp[每周一、三、五开奖]</h2>               
			</div>
			...
			<div class="right_box_cont">
				<div class="right_box_cont_top">
			  		<p class="blue_bor_b">
						...
						七乐彩 第<strong class="red f_14" id="termNO">${result.termNo}</strong>  期
					...
					<div class="prize_result">
	                    ...
	                    <ul id="termResult">
                            ...
                            <li class="red-ball">${fn:substring(result.result,18,20)}</li>
                            <li class="blue-ball">${fn:substring(result.result,21,23)}</li>
	                    </ul>
						<div style="float: right;"><a href="/prizedetail/qlcindex.htm" target="_blank">开奖历史</a> | <a href="/direction/fbt.htm?tt=js&type=qlc" target="_blank">走势图</a> </div>
			  		</div>
					
					<div class="clear"></div>
                    <div class="operation">
						<input type="image" src="../images/369caibg/369cai_40.gif" class="btn_dg" value="立即投注" onclick="parent.location.href='/lottery/index.htm?lotteryType=qlc'"/>                   	
                    </div>
...
var term=$("#term_no option:selected").val();
 ...
 $.LotteryTerm._request({action:'ajaxTermInfo',term: term,type:'qlc'});
}
</script>
