...
<title>四场进球${result.termNo}期开奖详情_中奖号码-一彩票</title>
<meta name="Keywords" content="四场进球${result.termNo}开奖,四场进球${result.termNo}中奖号码,四场进球${result.termNo}开奖详情" />
<meta name="Description" content="一彩票第一时间为您提供准确的四场进球${result.termNo}开奖,全面的四场进球${result.termNo}中奖号码信息，以及权威的四场进球${result.termNo}开奖详情,中奖分布等方便您查阅兑奖，祝您中大奖！" />
...
<div class = "container">
	<div class="prize_main">
		...
		<div class="right_box_info">
			<h3>一彩票首页 &gt; 开奖公告 &gt; 足彩 &gt; 四场进球开奖详情</h3>
           	<div class="right_box_title">
                <h4 class="pic_14sfc"></h4>
                <h4 style="padding-left:15px">四场进球开奖信息</h4><h2>&nbsp[不定期开奖]</h2>               
			</div>
			...
			<div class="right_box_cont">
				<div class="right_box_cont_top">
			  		<p class="blue_bor_b">
						...
						四场进球 第 <strong class="red f_14" id="termNO">${result.termNo}</strong> 期
					...
					<div class="prize_result">
						...
						<div style="float: right;"><a href="/prizedetail/4cjqindex.htm" target="_blank">开奖历史</a> | <a href="/direction/plt.htm?tt=cc&type=4cjq&football=football" target="_blank">走势图</a> </div>
			  		</div>
					
					<div class="clear"></div>
                    <div class="operation">
						<input type="image" src="../images/369caibg/369cai_40.gif" class="btn_dg" value="立即投注" onclick="parent.location.href='/lottery/index.htm?lotteryType=4cjq'"/>              	
                    </div>
...
var term=$("#term_no option:selected").val();
  ...
  $.LotteryTerm.callback = function(json){
	   ...
	   var str="";
		$(json.matchResultList4CJQ).each(function(i){
 ...
 $.LotteryTerm._request({action:'ajaxTermInfo',term: term,type:'4cjq'});
}
</script>
