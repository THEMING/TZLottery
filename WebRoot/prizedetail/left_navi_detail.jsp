	...
	$(document).ready(function()
		{
			...
			else if(type=="14sfc" || type=="r9" || type=="4cjq" || type=="6cb")
			{
				$("#welfare_lott").hide();
				$("#sport_lott").hide();
				$("#football_lott").show();				
...
<div class="left_box">
          ...
          <div class="left_box_tab" id="navigate_category">
              ...
              <ul id="welfare_lott" class="item">
                  <li id="item_ssq"><h1><img class="small_img" src="../images/lottery/pic_ssq.jpg"/><a href="/prizedetail/ssq_.htm">&nbsp; 双色球</a></h1></li>
                  <li id="item_3d"><h1><img class="small_img" src="../images/lottery/pic_fc3d.jpg"/><a href="/prizedetail/3d_.htm">&nbsp; 福彩3D</a></h1></li>
                  <li id="item_qlc"><h1><img class="small_img" src="../images/lottery/pic_qlc.jpg"/><a href="/prizedetail/qlc_.htm">&nbsp; 七乐彩</a></h1></li>
              </ul>
              <h2 class="tit"><a onclick="onclickSort(1)" class="ticai">全国体育彩票</a></h2>
              <ul id="sport_lott" class="item">
                  <li id="item_dlt"><h1><img class="small_img" src="../images/lottery/pic_dlt.jpg"/><a href="/prizedetail/dlt_.htm">&nbsp; 超级大乐透</a></h1></li>
                  <li id="item_qxc"><h1><img class="small_img" src="../images/lottery/pic_qxc.jpg"/><a href="/prizedetail/qxc_.htm">&nbsp; 七星彩</a></h1></li>
                  <li id="item_pls"><h1><img class="small_img" src="../images/lottery/pic_pls.jpg"/><a href="/prizedetail/pls_.htm">&nbsp; 排列3</a></h1></li>
                  <li id="item_plw"><h1><img class="small_img" src="../images/lottery/pic_plw.jpg"/><a href="/prizedetail/plw_.htm">&nbsp; 排列5</a></h1></li>
              </ul>
              <h2 class="tit"><a onclick="onclickSort(2)" class="zucai">足彩</a></h2>
              <ul id="football_lott" class="item">
                  <li><h1><img class="small_img" src="../images/lottery/pic_sfc.jpg"/><a href="/prizedetail/14sfc_.htm">&nbsp; 14场胜负彩</a></h1></li>
                  <li><h1><img class="small_img" src="../images/lottery/pic_rx9.jpg"/><a href="/prizedetail/r9_.htm">&nbsp; 任选9场</a></h1></li>
                  <li><h1><img class="small_img" src="../images/lottery/pic_scj.jpg"/><a href="/prizedetail/4cjq_.htm">&nbsp; 四场进球</a></h1></li>
                  <li><h1><img class="small_img" src="../images/lottery/pic_lcb.jpg"/><a href="/prizedetail/6cb_.htm">&nbsp; 六场半全场</a></h1></li>
