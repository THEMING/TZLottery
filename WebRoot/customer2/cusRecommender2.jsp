        ...
        <div class="customer-beizhu">
             <div class="ticheng">
                 ...
                 <div class="ticheng-con">
                    <span style="font-size:13px; font:'微软雅黑'; font-weight:bold; color:red; padding-bottom:7px; line-height:0;">提成比例高</span><br />
                    1	普通客户	1%	0.5%		帐户当月投注20元以上方计算佣金。<br />
                    2	网站及合作伙伴	≤ 4%		合作维系期间	网站不能再发展网站及其他代理商。<br />
                    3	公司销售	≤ 2% 	0.5%	在职期间	发展网站或其他合作伙伴按一次性奖金计算。<br />
                    4	代理商	≤ 4%		合作协议维系期间	季度达到一定业绩后，按0.5%返业务费。代理商发展网站另按协议计算。
                 </div>
             </div>
             <div class="ticheng2">
                 <div class="ticheng-img">
            	 	 <img src="../images/img/zhongshen.png" alt="终身">
                 </div>
                 <div class="ticheng-con">
                   <span style="font-size:13px; font:'微软雅黑'; font-weight:bold; color:red; line-height:0;">终身从属</span><br />
                   您一旦推广好友注册成功后、发展的会员将终身为您创造收益！
                 </div>
             </div>
             <div class="ticheng2">
                 <div class="ticheng-img">
            	 	 <img src="../images/img/dollar.png" alt="终身">
                 </div>
                 <div class="ticheng-con">
                 <span style="font-size:13px; font:'微软雅黑'; font-weight:bold; color:red; line-height:0;">返款无下限</span><br />
             ...
             <div class="ticheng2">
                 ...
                 <div class="ticheng-con">
                 <span style="font-size:13px; font:'微软雅黑'; font-weight:bold; color:red; line-height:0;">二级提成制</span><br />
