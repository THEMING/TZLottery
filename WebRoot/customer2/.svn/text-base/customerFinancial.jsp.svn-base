	...
	<div id="material_panel" class="tab_box">
        ...
        <div id="main1" class="main">
			<table cellspacing="0" cellpadding="0" class="customer_table">
				...
				<tr>
					<td class="right" width="80px" bgcolor="#FFCCFF">用户ID：</td>
				...
				<tr>
					<td class="right" bgcolor="#FFCCFF">账户总额：</td>
					<td class="left">${customer.wallet.balance+customer.wallet.freezeMoney}元</td>
					
				</tr>
				<tr>
					<td class="right" bgcolor="#FFCCFF">累计中奖：</td>
					<td class="left">￥${customer.allWinMoney}元</td>
				
				</tr>
				<tr>
					<td class="right" bgcolor="#FFCCFF">可用余额：</td>
        ...
        <div id="main3" class="main hidden">
        	<p>
       		...
       		<p>
                ...
                <span>元</span> <span class="red">（充值金额至少10元,免手续费） </span> 
                <div class="clear"></div>
        	<span style="margin-left:15px" class="red">充值超过50元，即可获得软件注册码，进入用户中心->软件注册界面可领取</span>
        	<div class="clear"></div>
   			</p>
            ...
            <div class="pay_box">
            	<input name="bankId" type="radio" id="bankId" value="/customer/alipayrequest.htm" checked/> <img src="../images/banks/pay_a.jpg" alt="支付宝支付"/> 
				<span style="margin-left:15px" class="red">(没有支付宝账号将为您自动创建账号)</span>        	
        	</div>
        	<div class="clear"></div>
        	<br/>
        	<div class="pay_box">
            	<input name="bankId" type="radio" id="bankId" value="/customer/kuaiqianrequest.htm"/> <img src="../images/banks/kuaiqian.jpg" alt="快钱支付"/> 
        	...
        	<br/>
        	<p>
   				<h1>3.银行汇款(无网上支付方式的用户也可通过银行汇款)</h1>
   			</p>
        	<div class="pay_box">
            	<br/>户名：北京比特太奇科技有限公司<br/> 账号：11001018400059261241 <br/>开户行：建行北京市西三旗支行 <br/>备注请填写网站用户名，汇款后请尽快联系客服查验入账 010-56203469, QQ2432882152
	        	...
	        	<table cellspacing="0" cellpadding="0" class="customer_table">
	             	...
	             	<tr>
	               	...
	               	<tr>
	              		...
	              		<td >
	              			<select name="province" id="province" onchange="checkcity()" >
	                       	</select>
