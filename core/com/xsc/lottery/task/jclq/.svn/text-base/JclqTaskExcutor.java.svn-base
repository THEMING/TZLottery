package com.xsc.lottery.task.jclq;
 ...
 */
@Component
public class JclqTaskExcutor implements ApplicationListener
{
	@Autowired
	...
	{
		//FIXME
		List<MatchArrange> matches = matchArrangeService.getCurrentMatchArrangeForJCLQ();
        ...
        return new Runnable()
        {
            public void run()
            {
                try {
                    ...
                    LotteryTerm currentTerm = termService.getCurrentTerm(LotteryType.竞彩篮球);
                    //根据该比赛产生订单
