...
@Component
public class _11x5sdHandle extends BaseLotteryHandle {

	@Override
	public LotteryType getLotteryType() {
		
		return LotteryType.十一运夺金;
	}
	...
	public static void main(String[] args) {
		...
		order.setMultiple(1);
		order.setTerm(term);
		order.setType(LotteryType.十一运夺金);
		...
		_11x5sdHandle _11x5sdHandle = new _11x5sdHandle();
		
		List<Ticket> tickets = _11x5sdHandle.unpackTicketForWZL(order, item);
