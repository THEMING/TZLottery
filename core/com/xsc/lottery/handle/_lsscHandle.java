...
@Component
public class _lsscHandle extends BaseLotteryHandle {

	@Override
	public LotteryType getLotteryType() {
		// TODO Auto-generated method stub
		
		return LotteryType.老11选5;
	}
	...
	public static void main(String[] args) {
		...
		order.setMultiple(1);
		order.setTerm(term);
		order.setType(LotteryType.老11选5);
		...
		List<Ticket> tickets = _lsscHandle.unpackTicketForWZL(order, item);
