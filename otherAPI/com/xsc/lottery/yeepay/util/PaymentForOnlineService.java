...
public class PaymentForOnlineService
{
    ...
    private static String p1_MerId = Configuration.getInstance().getValue(
            "yeepay.p1_MerId"); // 商家ID
    private static String queryRefundReqURL = Configuration.getInstance()
            .getValue("yeepay.queryRefundReqURL"); // 请求地址
    public static String keyValue = Configuration.getInstance().getValue(
            "yeepay.keyValue"); // 商家密钥
    ...
    public static String getHttpParamForOnlinePayment(String p0_Cmd,
    ...
    {
        String hmac = getReqMd5HmacForOnlinePayment(p0_Cmd, p2_Order, p3_Amt,
    ...
    public static QueryResult queryByOrder(String p2_Order)
    {
        ...
        try {
            ...
            responseStr = YeePayHttpUtils.URLGet(queryRefundReqURL, reParams);
