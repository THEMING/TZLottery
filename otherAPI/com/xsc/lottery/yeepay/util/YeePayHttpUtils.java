...
public class YeePayHttpUtils
{

    private static final String URL_PARAM_CONNECT_FLAG = "&";
    private static final int SIZE = 1024 * 1024;
    private static Log log = LogFactory.getLog(YeePayHttpUtils.class);

    private YeePayHttpUtils()
    {
    }

    public static List<String> URLGet(String strUrl, Map map)
            throws IOException
    {
        String strtTotalURL = "";
    ...
    public static List<String> URLPost(String strUrl, Map map)
            throws IOException
    {
